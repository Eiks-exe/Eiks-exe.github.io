...
const projects: ProjectProps[] = [
  {
    ...
    tagline:
      "A Modular and 100% scalable TypeScript bot with multiple features. One of them automates voice-channel management on Discord. It watches specific “host” channels stored in SQLite, creates a personal voice channel when someone joins, and moves the user into it automatically.",
    points: [
  ...
  },
  {
    title: "RainRush",
    tagline:
      "RainRush is a desktop app and backend system that logs and analyzes Risk of Rain 2 gameplay in real time. It integrates directly with the game through a custom mod and feeds run data into a Tauri-based client and a Node/Express API backed by MySQL.",
    points: [
